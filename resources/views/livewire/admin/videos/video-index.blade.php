                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-base-900">{{ $video->name }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-base-900">{{ $video->youtube_url }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end space-x-3">
                                        ...
                                        {{-- eliminar --}}
                                        <button wire:click="destroy({{ $video->id }})"
                                            wire:confirm="¿Estás seguro de eliminar el producto {{ $video->name }}?"
