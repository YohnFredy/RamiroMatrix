...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <i class="fas fa-cart-arrow-down"></i> Videos
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalced986e8ff6641d3797206c3198c2b83)): ?>
<?php $attributes = $__attributesOriginalced986e8ff6641d3797206c3198c2b83; ?>
...
<?php endif; ?>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mt-8 mb-4 px-6">
        <div>
            <h1 class="text-2xl font-bold text-primary-700">Gestión de videos</h1>
            <p class="text-sm text-base-900 mt-1">Administra tus videos</p>
        </div>
        ...
        <div class="p-5 border-b border-neutral-300 bg-white">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-semibold text-base-900">Lista de videos</h2>
                </div>
                <!-- Buscador mejorado -->
                <div class="relative">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-neutral-300">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div wire:key="<?php echo e($video->id); ?>">
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-base-900"><?php echo e($video->name); ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-base-900"></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-base-900"><?php echo e($video->youtube_url); ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end space-x-3">
                                        ...
                                        <button wire:click="destroy(<?php echo e($video->id); ?>)"
                                            wire:confirm="¿Estás seguro de eliminar el producto <?php echo e($video->name); ?>?"
...
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/livewire/admin/videos/video-index.blade.php ENDPATH**/ ?>