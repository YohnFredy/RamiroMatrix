    ...
    <!--[if BLOCK]><![endif]--><?php if(!empty($node['children'])): ?>
        <ul>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $node['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('livewire.office.children-matrix', ['node' => $child], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
        </ul>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</li>
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/livewire/office/children-matrix.blade.php ENDPATH**/ ?>