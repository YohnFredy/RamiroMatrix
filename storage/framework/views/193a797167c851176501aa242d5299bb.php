...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        ...
        'subtle' => 'bg-transparent hover:bg-primary-50',
    })
    ->add(match ($variant) { // Text color...
        ...
        'subtle' => 'text-accent-3 hover:text-primary-700',
    })
    ->add(match ($variant) { // Border color...
        'primary' => 'border border-primary-700',
...
<?php endif; ?>
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/flux/button/index.blade.php ENDPATH**/ ?>