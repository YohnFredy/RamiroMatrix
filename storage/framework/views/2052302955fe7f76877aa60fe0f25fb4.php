                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div wire:key="<?php echo e($product->id); ?>">
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <th scope="row" class="">
                                    <!--[if BLOCK]><![endif]--><?php if($product->latestImage): ?>
                                        <img class=" h-10 mx-auto" src="<?php echo e(Storage::url($product->latestImage->path)); ?>"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">$<?php echo e(number_format($product->final_price, 0)); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end space-x-3">
                                        ...
                                        <button wire:click="destroy(<?php echo e($product->id); ?>)"
                                            wire:confirm="¿Estás seguro de eliminar el producto <?php echo e($product->name); ?>?"
...
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/livewire/admin/products/product-index.blade.php ENDPATH**/ ?>