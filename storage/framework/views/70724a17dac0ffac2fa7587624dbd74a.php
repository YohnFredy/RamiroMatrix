...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginalced986e8ff6641d3797206c3198c2b83 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalced986e8ff6641d3797206c3198c2b83 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::breadcrumbs.item','data' => ['href' => ''.e(route('admin.products.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::breadcrumbs.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('admin.products.index')).'']); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <i class="fas fa-cart-arrow-down"></i> categoria
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalced986e8ff6641d3797206c3198c2b83)): ?>
<?php $attributes = $__attributesOriginalced986e8ff6641d3797206c3198c2b83; ?>
...
<?php endif; ?>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mt-8 mb-4 px-6">
        <div>
            <h1 class="text-2xl font-bold text-primary-700">Gestión de categorias</h1>
        ...
        <div class="p-5 border-b border-neutral-300 bg-white">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-semibold text-base-900">Lista de Categorías</h2>
                </div>
                <!-- Buscador mejorado -->
                <div class="relative">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search','data' => ['wire:model' => 'search','wire:keydown.enter' => 'searchEnter','placeholder' => 'Buscar categorías...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'search','wire:keydown.enter' => 'searchEnter','placeholder' => 'Buscar categorías...']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                        ...
                        <div wire:key="<?php echo e($category->id); ?>">
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            class="flex-shrink-0 h-8 w-8 bg-primary-700/10 rounded-md flex items-center justify-center">
                                            <i class="fas fa-folder text-primary-700"></i>
                                        </div>
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-base-900"><?php echo e($category->name); ?></div>
                                        </div>
                                    </div>
                                </td>

                                <td class="px-6 py-4 whitespace-nowrap">
                                    <!--[if BLOCK]><![endif]--><?php if($category->parent_id): ?>
                                        <div class="flex items-center">
                                            <i class="fas fa-level-up-alt text-base-900 mr-2 transform rotate-90"></i>
                                            <span class="text-sm text-base-900"><?php echo e($category->parent->name ?? 'N/A'); ?></span>
                                        </div>
                                    <?php else: ?>
                                        <span class="text-sm text-base-900 italic">Categoría principal</span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end space-x-3">
                                        ...
                                        <button wire:click="destroy(<?php echo e($category->id); ?>)"
                                            wire:confirm="¿Estás seguro de eliminar el producto <?php echo e($category->name); ?>?"
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-primary-700 font-medium mb-1">No se encontraron categorías</p>
                                    <p class="text-base-900 text-sm">No hay categorías disponibles para mostrar</p>
...
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/livewire/admin/categories/category-index.blade.php ENDPATH**/ ?>