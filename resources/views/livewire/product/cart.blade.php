<div class="grid grid-cols-6 gap-6">
    <div class=" col-span-6 md:col-span-4 ">
        <h2 class=" text-primary-700  border-b sm:border-none border-neutral-400 pb-2 sm:pb-0">Carro ({{ $quantity }}
            productos)
        </h2>
        <div class=" sm:bg-white rounded-md sm:shadow-md shadow-base-900 sm:border border-neutral-300 sm:p-4 mt-2">
                    ...
                    @foreach ($products as $product)
                        ...
                        <div class="col-span-9 lg:col-span-5 flex items-center">
                            <div class=" text-sm text-primary-700">
                                ...
                                <p class="mt-2 text-justify  line-clamp-3 text-base-900">
                        ...
                        <div class="col-span-4 lg:col-span-2 flex items-center justify-center">
                            <div class="text-sm">
                                ...
                                {{--   <p class=" text-accent-2 mt-2"> Pts_base: {{ $product['pts_base'] }}</p> --}}
                            </div>
                        </div>
                        ...
                        <div class="col-span-7 lg:col-span-3 flex items-center justify-center">
                            <div>
                                <button wire:click="decrement({{ $product['index'] }})"
                                    class="bg-primary-700  py-1 px-3 rounded-md hover:bg-secondary-600  text-neutral-200 hover:text-white ">-</button>
                                <input type="text"
                        ...
                        <div wire:click="removeFromCart({{ $product['index'] }})"
                            class="col-span-1 lg:col-span-1 flex items-center justify-center cursor-pointer text-accent-3 hover:text-accent-3/80">
    ...
    <div class="col-span-6 md:col-span-2">
        <!-- Header -->
        <div class="mb-4">
            <h2 class="text-lg font-semibold text-primary-700">Resumen de la orden</h2>
