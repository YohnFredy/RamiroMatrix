...
<?php elseif ($heading): ?>
    <div <?php echo e($attributes->class('block space-y-[2px]')); ?>>
        <div class="px-3 py-2">
            <div class="text-sm text-base-900 font-medium leading-none"><?php echo e($heading); ?></div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/flux/navlist/group.blade.php ENDPATH**/ ?>