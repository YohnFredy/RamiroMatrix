...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::breadcrumbs.index','data' => ['class' => 'md:hidden mb-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'md:hidden mb-4']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('home')).'']); ?>Inicio <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginalced986e8ff6641d3797206c3198c2b83 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalced986e8ff6641d3797206c3198c2b83 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::breadcrumbs.item','data' => ['href' => ''.e(route('videos.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::breadcrumbs.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('videos.index')).'']); ?>Videos <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalced986e8ff6641d3797206c3198c2b83)): ?>
<?php $attributes = $__attributesOriginalced986e8ff6641d3797206c3198c2b83; ?>
<?php unset($__attributesOriginalced986e8ff6641d3797206c3198c2b83); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 md:gap-x-8 gap-y-6">
            ...
            <div class="lg:col-span-2">
                <div class="-mx-5 sm:mx-0">
                    <div class="relative w-full" style="padding-bottom: 56.25%;">
                        <iframe id="youtube-player" class="absolute top-0 left-0 w-full h-full md:rounded-xl shadow-lg"
                             src="https://www.youtube.com/embed/<?php echo e($video->youtube_url); ?>?enablejsapi=1"
                            title="<?php echo e($video->name); ?>" frameborder="0"
                ...
                <div class="mt-4 px-2 sm:px-0">
                    <h1 class="text-xl font-bold text-base-800"><?php echo e($video->name); ?></h1>
                    <p class="text-sm text-base-600 mt-1"><?php echo e($video->short_description); ?></p>
                </div>
            </div>
            ...
            <div class="lg:col-span-1 px-2 sm:px-0">
                ...
                <div class="flex flex-col space-y-4 lg:h-[500px] lg:overflow-y-auto lg:pr-2">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nextVideo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <!-- 2. Tarjeta de video responsiva -->
                        <!-- Por defecto (móvil) es un 'block'. En 'md' y superior, se convierte en 'flex' -->
                        <a href="<?php echo e(route('videos.show', $nextVideo->slug)); ?>"
                           class="group block md:flex md:items-start md:space-x-3">
                            ...
                            <div class="w-full md:w-40 md:flex-shrink-0">
                                <img src="https://img.youtube.com/vi/<?php echo e($nextVideo->youtube_url); ?>/hqdefault.jpg"
                                    alt="<?php echo e($nextVideo->name); ?>"
                            ...
                            <div class="mt-2 md:mt-0 md:flex-grow">
                                <p class="text-sm font-semibold text-base-800 leading-tight group-hover:text-accent-3 transition-colors">
                                    <?php echo e($nextVideo->name); ?>

                                </p>
                                <p class="text-xs text-base-500 mt-1"><?php echo Str::limit($nextVideo->short_description, 40); ?></p>
                            </div>
                        </a>
        ...
        function onPlayerStateChange(event) {
            ...
            if (event.data == YT.PlayerState.PLAYING) {
                ...
                if (!trackingSessionStarted) {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').startVideoTracking(duration);
                ...
                progressInterval = setInterval(() => {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').updateProgress(currentTime); 
            ...
            if (event.data == YT.PlayerState.ENDED) {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').markAsCompleted();
            }
        }
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/livewire/video/video-show.blade.php ENDPATH**/ ?>