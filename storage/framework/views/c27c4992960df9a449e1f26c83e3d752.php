...
$classes = Flux::classes()
    ...
    ->add(match ($variant) {
        'outline' => match ($accent) {
            true => [
                'data-current:text-primary-700 hover:data-current:text-primary-600',
                'data-current:bg-white data-current:border data-current:border-primary-600',
...
<?php endif; ?>
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/flux/navlist/item.blade.php ENDPATH**/ ?>