<div>
    ...
    <div class="sm:bg-white sm:px-6 sm:pb-8 rounded-lg sm:shadow-md shadow-base-900 sm:border border-neutral-50">
                ...
                <div>
                    ...
                    @else
                        @if ($product->images->count() > 0)
                            <img class="w-full rounded-lg shadow-md shadow-base-600"
            ...
            <div class="col-span-8 sm:col-span-4 mt-3">
                <div>
                    <div class="flex items-center justify-between">
                        <h1 class="text-3xl font-extrabold tracking-tight text-primary-700 capitalize">{{ $product->name }}
                        </h1>
                        @if ($product->brand)
                            <a href="{{-- {{ route('brands.show', $product->brand) }} --}}" class="text-sm font-medium text-accent-2 hover:text-primary-700">
                                {{ $product->brand->name }}
                            </a>
                        @endif
                    </div>
                    ...
                    <!-- Precio -->
                    <div class="mt-4">
                        <p class="text-2xl text-secondary-600">
                    ...
                    <!-- Descripción breve -->
                    <div class="mt-6">
                        <p class="text-base text-base-900">
                            {!! $product->description !!}
                        </p>
                    </div>
                        ...
                        <div class="mt-6">
                            <div class="flex items-center">
                                @if ($product->stock > 0 || $product->allow_backorder)
                                    <svg class="h-5 w-5 text-accent-2" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                            clip-rule="evenodd" />
                                    </svg>
                                    <p class="ml-2 text-sm text-primary-700">
                                        @if ($product->stock > 0)
                                ...
                                @else
                                    <svg class="h-5 w-5 text-accent-3" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"
                                            clip-rule="evenodd" />
                                    </svg>
                                    <p class="ml-2 text-sm text-accent-3">
                                        Agotado
                                    </p>
                                @endif
                            </div>
                    ...
                    <div class="mt-8">
                        <div class="flex items-center">
                            <span class="mr-3 text-base-900">Cantidad</span>
                            <div class="flex items-center border border-neutral-300 rounded-md">
                                <button wire:click="decrementQuantity"
                                    class="px-3 py-1 text-base-900 hover:bg-neutral-100 focus:outline-none">
                                    -
                                </button>
                                <span class="px-3 py-1 text-base-900">{{ $quantity }}</span>
    ...
    <div
        ...
        <div class="col-span-2 md:col-span-1 ">
            <h1 class=" text-lg text-primary-700 font-medium pb-1 border-b border-secondary-600">Especificaciones</h1>
            <div class="mt-4">
        ...
        <div class="col-span-2 md:col-span-1">
            <h1 class="text-lg text-primary-700 font-medium pb-1 border-b border-secondary-600">Información</h1>
            <div class="mt-4">
                {!! $product->information !!}
            </div>
        </div>
    ...
    <flux:modal wire:model.live="modalCart" :dismissible="false" class="">
        <flux:heading class="text-primary-700! pr-6" size="lg">Lo que agregas al carrito
        </flux:heading>

        <div
            class=" grid grid-cols-10 gap-2 border-y border-neutral-400 divide-y divide-neutral-300  sm:divide-none py-4 mt-4 text-base-900">
