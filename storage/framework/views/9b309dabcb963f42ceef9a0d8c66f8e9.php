...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search','data' => ['wire:model' => 'search','wire:model.live.debounce.300ms' => 'search','placeholder' => 'Buscar venta...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'search','wire:model.live.debounce.300ms' => 'search','placeholder' => 'Buscar venta...']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-neutral-300">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div wire:key="<?php echo e($sale->id); ?>">
                            <tr class="hover:bg-gray-50 transition-colors duration-150">

                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($sale->invoice_number); ?></td>
                                <td class="px-6 py-4 "><?php echo e($sale->user->name); ?></td>
                                <td class="px-6 py-4 "><?php echo e($sale->seller->name); ?></td>
                                <td class="px-6 py-4 "><?php echo e($sale->business->name); ?></td>
                                <td class="px-6 py-4 "><?php echo e($sale->business->name); ?></td>
                                <td class="px-6 py-4 "> $<?php echo e(number_format($sale->total_sale_amount, 2)); ?></td>

                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center space-x-3">

                                        
                                        <a href="<?php echo e(route('admin.sales.edit', $sale)); ?>"
                                            class="text-secondary-600 hover:text-secondary-600/80 transition-colors p-1.5 rounded-md hover:bg-secondary-600/10">
                                            <i class="fas fa-edit"></i>
                                        </a>

                                        
                                        <button wire:click="deleteSale(<?php echo e($sale->id); ?>)"
                                            wire:confirm="¿Estás seguro de eliminar el negocio aliado <?php echo e($sale->name); ?>?"
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(!empty($this->search)): ?>
                                        <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['variant' => 'primary','wire:click' => 'clearSearch','class' => ' mt-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','wire:click' => 'clearSearch','class' => ' mt-4']); ?>
                                            Limpiar búsqueda
                                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/livewire/admin/sales/sales-index.blade.php ENDPATH**/ ?>