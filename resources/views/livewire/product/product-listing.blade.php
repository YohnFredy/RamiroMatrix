<div>
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="hidden lg:block lg:w-1/3 xl:w-1/4 2xl:w-1/5">
            <div
                class="bg-white rounded-lg shadow-md shadow-base-900 border border-neutral-300 px-4 py-2 divide-y divide-neutral-400 sticky top-4">
        ...
        <div class="flex-1">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:gap-4">
                            ...
                            <div class="w-full md:w-80 mb-2 md:mb-0 relative">
                                <input type="text" wire:model.live.debounce.300ms="search"
                                    class="block w-full ps-10 pr-15 bg-white border border-primary-600/50 text-primary-600 text-sm rounded-lg focus:outline-1 focus:outline-primary-600 focus:bg-white  py-2 px-2.5"
                                    placeholder="Buscar productos...">

                                <div class=" absolute left-0.5 top-0 px-3 py-2 text-primary-600">
                    ...
                    <div class="col-span-4 md:col-span-1 hidden md:block ">
                        ...
                        <div class="relative">
                            <select wire:model.live="sortBy"
                                class="block w-full  bg-neutral-50/50 appearance-none border border-gray-300 text-primary-600 text-sm rounded-lg focus:outline-1 focus:outline-primary-600 focus:bg-white py-2 px-2.5 cursor-pointer">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-6 gap-2 mt-3 lg:hidden">
                ...
                <div class="col-span-1 sm:col-span-2 relative w-full">
                    <select wire:model.live="sortBy"
                        class="block w-full bg-neutral-50/50 appearance-none border border-gray-300 text-primary-600 text-sm rounded-lg focus:outline-1 focus:outline-primary-600 focus:bg-white p-2.5 cursor-pointer">
                        <option selected>Ordenar por</option>
                        <option value="newest">Más recientes</option>
                        <option value="price_asc">Precio: menor a mayor</option>
                        <option value="price_desc">Precio: mayor a menor</option>
            ...
            {{-- <span class="text-primary-600">Mostrando {{ $products->count() }} de {{ $products->total() }}
                    productos</span> --}}
                    ...
                    <div
                        ...
                        @foreach ($products as $product)
                            <div wire:key="{{ $product->id }}"
                                class="bg-white rounded-xl shadow-md shadow-base-900/50 border border-neutral-200 overflow-hidden group flex flex-col">
                                ...
                                <div
                                    ...
                                    <div class="absolute top-3 right-3 flex flex-col gap-2 z-20">
                                        @if ($product->stock == 0 && !$product->allow_backorder)
                                            <div
                                                class="bg-accent-3 text-white px-3 py-1 rounded-md text-xs font-medium shadow-sm">
                                                Agotado
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="absolute top-3 left-3 z-20">
                                        @if (!$product->is_physical)
                                            <div
                                                class="bg-primary-600 text-white px-3 py-1 rounded-md text-xs font-medium shadow-sm">
                                                Digital
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="p-4 bg-secondary-600/6 flex flex-col flex-grow">
                                    <!-- Marca y precio -->
                                    <div class="mb-2">
                                        @if ($product->brand)
                                            <span
                                                class="text-xs text-primary-600 font-semibold tracking-wide uppercase block">
                                                {{ $product->brand->name }}
                                            </span>
                                        @endif
                                        <h3 class="font-bold text-primary-600 text-base sm:text-lg truncate">
                                    ...
                                    <!-- Descripción -->
                                    <p class="text-base-900 text-xs sm:text-sm mb-4 line-clamp-2 leading-relaxed">
                                    ...
                                    <div class="mt-auto flex justify-between items-center">
                                        @if ($product->category)
                                            <span
                                                class="text-xs bg-accent-2/5 text-accent-2 px-2 sm:px-3 py-1 rounded-lg font-medium">
