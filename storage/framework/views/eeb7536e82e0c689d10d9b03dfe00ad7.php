...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'matrix']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'matrix']); ?>
    <!-- VIDEO EXPLICATIVO -->
...
<?php if($video): ?>
    <div class="relative mx-auto max-w-3xl rounded-2xl overflow-hidden shadow-2xl bg-black">
        <div class="aspect-video">
            <iframe 
                src="https://www.youtube.com/embed/<?php echo e($video->youtube_url); ?>" 
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-2">
                        <a href="<?php echo e(route('register', 'master')); ?>"
    ...
    <div
        ...
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register', 'master')); ?>" target="_blank" rel="noopener noreferrer"
...
<?php endif; ?>
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/index.blade.php ENDPATH**/ ?>