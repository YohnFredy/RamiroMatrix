    ...
    <div
        ...
        <div class="caja">
            <div id="tree-container" class="tree px-2">
                <ul>
                    <?php echo $__env->make('livewire.office.children-matrix', ['node' => $tree], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-md shadow-base-900 hover:shadow-lg transition-shadow overflow-hidden">
            ...
            <div class="p-6">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <h3 class="text-lg font-bold capitalize"><?php echo e($currentUser->name); ?> <?php echo e($currentUser->last_name); ?></h3>
                        <div class="flex items-center">
...
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/livewire/office/matrix-tree.blade.php ENDPATH**/ ?>