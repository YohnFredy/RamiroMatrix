<div>
    ...
    <div class="grid grid-cols-4 gap-x-4 gap-y-6">
        ...
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $unwatchedVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div wire:key="<?php echo e($video->id); ?>" class="col-span-4 md:col-span-2 lg:col-span-1">
                ...
                <a href="<?php echo e(route('videos.show', $video->slug)); ?>" class="group">
                    ...
                    <div class="relative overflow-hidden rounded-lg shadow-lg">
                        ...
                        <img src="https://img.youtube.com/vi/<?php echo e($video->youtube_url); ?>/hqdefault.jpg"
                            alt="<?php echo e($video->name); ?>"
                    ...
                    <div class="mt-2">
                        ...
                        <p class="text-xs text-base-600 mt-1">
                            <?php echo e($video->short_description); ?>
    ...
    <div class="grid grid-cols-4 gap-x-4 gap-y-6 mt-10">
        ...
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $videosViewed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div wire:key="<?php echo e($video->id); ?>" class="col-span-4 md:col-span-2 lg:col-span-1">
                <!-- 1. El enlace principal que envuelve toda la tarjeta -->
                <!-- Usamos la clase 'group' para controlar efectos hover en los elementos hijos -->
                <a href="<?php echo e(route('videos.show', $video->slug)); ?>" class="group">
...
<?php /**PATH C:\Users\Fredy\Herd\matrix\resources\views/livewire/video/video-index.blade.php ENDPATH**/ ?>