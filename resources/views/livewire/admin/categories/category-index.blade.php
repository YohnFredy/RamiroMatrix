<div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mt-8 mb-4 px-6">
        <div>
            <h1 class="text-2xl font-bold text-primary">Gestión de categorias</h1>
        ...
        <div class="p-5 border-b border-neutral-300 bg-white">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-semibold text-ink">Lista de Categorías</h2>
                </div>
                <!-- Buscador mejorado -->
                <div class="relative">
                        ...
                        <div wire:key="{{ $category->id }}">
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            class="flex-shrink-0 h-8 w-8 bg-primary/10 rounded-md flex items-center justify-center">
                                            <i class="fas fa-folder text-primary"></i>
                                        </div>
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-ink">{{ $category->name }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if ($category->parent_id)
                                        <div class="flex items-center">
                                            <i class="fas fa-level-up-alt text-ink mr-2 transform rotate-90"></i>
                                            <span class="text-sm text-ink">{{ $category->parent->name ?? 'N/A' }}</span>
                                        </div>
                                    @else
                                        <span class="text-sm text-ink italic">Categoría principal</span>
                                    @endif
                                </td>
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-primary font-medium mb-1">No se encontraron categorías</p>
                                    <p class="text-ink text-sm">No hay categorías disponibles para mostrar</p>
