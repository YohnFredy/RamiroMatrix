                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-base-900">{{ $category->name }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if ($category->parent_id)
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-sm text-base-900">{{ $category->parent->name ?? 'N/A' }}</span>
                                        </div>
                                    @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end space-x-3">
                                        ...
                                        <button wire:click="destroy({{ $category->id }})"
                                            wire:confirm="¿Estás seguro de eliminar el producto {{ $category->name }}?"
